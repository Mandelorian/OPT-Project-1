...
public class ProductList {
    ...
    public static void setDefaultOptionList() {
       ...
       if(new File("./saved/options.json").exists()) {
        ...
        optionList.add(new Option("Elektrische kookplaten", 10_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 30_000, Utility.getBoatByName("Jacht")));
        optionList.add(new Option("Duurzame uitlaat filters", 2_500_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 5_000_000, Utility.getBoatByName("Jacht")));
        optionList.add(new Option("Zonnepanelen", 5_000_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 10_000_000, Utility.getBoatByName("Jacht")));
        ...
        optionList.add(new Option("Duurzame uitlaat filters", 5_000_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 10_000_000, Utility.getBoatByName("Cruise schip")));
        optionList.add(new Option("Zonnepanelen", 5_000_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 10_000_000, Utility.getBoatByName("Cruise schip")));
        ...
        optionList.add(new Option("Duurzame uitlaat filters", 5_000_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 10_000_000, Utility.getBoatByName("Containerschip")));
        optionList.add(new Option("Zonnepanelen", 5_000_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 10_000_000, Utility.getBoatByName("Containerschip")));
        ...
        optionList.add(new Option("Duurzame uitlaat filters", 5_000_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 10_000_000, Utility.getBoatByName("Tanker")));
        optionList.add(new Option("Zonnepanelen", 5_000_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 10_000_000, Utility.getBoatByName("Tanker")));
        ...
        optionList.add(new Option("Duurzame uitlaat filters", 5_000_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 10_000_000, Utility.getBoatByName("Veerboot")));
        optionList.add(new Option("Zonnepanelen", 5_000_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 10_000_000, Utility.getBoatByName("Veerboot")));
        ...
        optionList.add(new Option("Elektrische motor", 25_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 50_000, Utility.getBoatByName("Speedboot")));
        optionList.add(new Option("Duurzamer/gerecycled rubber", 10_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 20_000, Utility.getBoatByName("Speedboot")));
        ...
        optionList.add(new Option("Elektrische motor", 25_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 50_000, Utility.getBoatByName("Vissersboot")));
        optionList.add(new Option("Zonnepanelen", 50_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 100_000, Utility.getBoatByName("Vissersboot")));
        ...
        optionList.add(new Option("Elektrische motor", 25_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 50_000, Utility.getBoatByName("Pontonboot")));
        optionList.add(new Option("Zonnepanelen", 50_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 100_000, Utility.getBoatByName("Pontonboot")));
        ...
        optionList.add(new Option("Zonnepanelen", 50_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 100_000, Utility.getBoatByName("Sleepboot")));
        optionList.add(new Option("Duurzame uitlaatfilters", 100_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 200_000, Utility.getBoatByName("Sleepboot")));
        ...
        optionList.add(new Option("Elektrische motor", 25_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 50_000, Utility.getBoatByName("Motorjacht")));
        optionList.add(new Option("Elektrische kookplaat", 10_000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 20_000, Utility.getBoatByName("Motorjacht")));
        ...
        optionList.add(new Option("Duurzamer/gerecycled kunststof", 200,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 400, Utility.getBoatByName("Kano")));
        ...
        optionList.add(new Option("Zonnepanelen", 1000,"Dit is een optie met milieukorting en word afgetrokken van de totaal prijs.", 2000, Utility.getBoatByName("Zeilbootje")));
        //opties voor jacht
